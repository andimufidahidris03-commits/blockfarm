...
declare module "@nomicfoundation/hardhat-ethers/types" {
  ...
  getContractFactory(name: 'BlockFarm', signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.BlockFarm__factory>
getContractFactory(name: 'Counter', signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.Counter__factory>

  getContractAt(name: 'BlockFarm', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.BlockFarm>
getContractAt(name: 'Counter', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.Counter>

  deployContract(name: 'BlockFarm', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.BlockFarm>
deployContract(name: 'Counter', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.Counter>

  deployContract(name: 'BlockFarm', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.BlockFarm>
